...
let dapat = (Math.floor(Math.random() * 10000000000))
let nomors = m.sender
  let who
  if (m.isGroup) who = m.mentionedJid[0]
  else who = m.chat
  if (!who) throw 'tag yang mau dientod'
  if (typeof db.data.users[who] == 'undefined') throw 'target sedang bersembunyi disemak'
  ...
  if (10000 > users[who].money) throw 'target udah dieue goblok, berbekas dia'
